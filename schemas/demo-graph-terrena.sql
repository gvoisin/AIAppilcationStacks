-- Oracle Property Graph definition for Terrena demo operations.
-- Requires the relational objects from demo-schema.sql and demo-data-terrena.sql.
-- Syntax aligned with Oracle CREATE PROPERTY GRAPH grammar.

CREATE OR REPLACE PROPERTY GRAPH terrena_operations
  VERTEX TABLES (
